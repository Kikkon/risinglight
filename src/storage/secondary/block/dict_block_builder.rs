...
/// ```plain
/// | rle_count_sum(u32) |  dict_count_sum (u32) | rle_block | dict_block |
/// ```
    ...
    <A::Item as ToOwned>::Owned: Eq + Hash,
{
    ...
    fn finish(self) -> Vec<u8> {
        ...
        encoded_data.put_u32(self.rle_builder.get_rle_count_num() as u32);
        encoded_data.put_u32(self.dict_map.len() as u32);

        encoded_data.extend(self.rle_builder.finish());
